...
const Book = ({ book }) => {
  const { bookId, image, bookName, author, tags, rating, category, totalPages } = book;
  return (
    <Link to={`/books/${bookId}`}>
      <div className="card bg-base-100 shadow-2xl w-96 mt-8 mb-8 p-6 h-[482px] flex flex-col justify-between">
